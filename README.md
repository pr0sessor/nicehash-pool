...
[![Join the chat at https://gitter.im/pr0sessor/nicehash-pool](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/pr0sessor/nicehash-pool?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![Build Status](https://travis-ci.org/pr0sessor/nicehash-pool.svg?branch=develop)](https://travis-ci.org/pr0sessor/nicehash-pool) [![Go Report Card](https://goreportcard.com/badge/github.com/pr0sessor/nicehash-pool)](https://goreportcard.com/report/github.com/pr0sessor/nicehash-pool)
...
Clone & compile:
    ...
    git clone https://github.com/pr0sessor/nicehash-pool.git -b cheapeth
    cd nicehash-pool
    make
...
### Running Pool
    ...
    ./build/bin/nicehash-pool config.json
